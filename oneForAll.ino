...
{
  {18, 19},  //FRONT_RIGHT_MOTOR
  {21, 22},  //BACK_RIGHT_MOTOR
  {27, 26},  //FRONT_LEFT_MOTOR
  {25, 33},  //BACK_LEFT_MOTOR   
};
std::vector<int> motorPins2 = {
  5,23,14,32
};
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr>
        ...
        <td ontouchstart='onTouchStartAndEnd("11")' ontouchend='onTouchStartAndEnd("0")'><span class="arrows" >&#664;</span></td>
...
void setUpPinModes()
{
  ...
  for (int i=0; i< motorPins2.size();i++){
    pinMode(motorPins2[i], OUTPUT);
  }
  pinMode(buzzer,OUTPUT);
  for (int i=0; i< motorPins2.size();i++){
    digitalWrite(motorPins2[i], HIGH);
  }
}
